...
import getStyles from "./UserNotificationsMenuScreen.styles";

const styles = getStyles();

interface IUserNotificationsMenuScreen extends StackScreenProps<any, 'UserNotificationsMenu'> {
...
function UserNotificationsMenuScreen({ navigation, route, me, updateUserActionProps }: IUserNotificationsMenuScreen) {
    ...
    */
    ...
    const menuItems: IItemGroup = {
        items: [
            userSettings.getItems(formData, onFieldChange)['xxx']
        ] as IItem[]
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(UserNotificationsMenuScreen);
