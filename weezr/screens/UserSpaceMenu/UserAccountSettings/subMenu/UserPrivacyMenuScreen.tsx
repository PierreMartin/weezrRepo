...
import getStyles from "./UserPrivacyMenuScreen.styles";

const styles = getStyles();

interface IUserPrivacyMenuScreen extends StackScreenProps<any, 'UserPrivacyMenu'> {
...
function UserPrivacyMenuScreen({ navigation, route, me, updateUserActionProps }: IUserPrivacyMenuScreen) {
    ...
    */
    ...
    const menuItems: IItemGroup = {
        items: [
            userSettings.getItems(formData, onFieldChange)['blockedsProfiles']
        ] as IItem[]
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(UserPrivacyMenuScreen);
